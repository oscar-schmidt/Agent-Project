...
DATA_PATH = os.getenv("DATA_PATH", ".agents/pdf2sql_agent/data/tech_service_reviews_500_with_names_ratings.csv")
...
AGENT_CHECKPOINT_DB = os.getenv("AGENT_CHECKPOINT_DB", "pdf2sql_agent.db")
