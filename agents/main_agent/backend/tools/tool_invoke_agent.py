...
async def tool_agent_async(state: GraphState, adaptor = None) -> GraphState:
...
@log_decorator
async def tool_agent(state: GraphState, adaptor = None) -> GraphState:
...
@log_decorator
async def invoke_tool(message, bind_tools, state: GraphState, adaptor = None) -> GraphState:
